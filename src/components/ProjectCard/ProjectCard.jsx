...
function ProjectCard({ laptopImg, mobileImg, title, description, demoLink, codeLink, className }) {
    return (
        <div className='rounded-md relative pt-8 pb-16 md:pb-10 mt-14 w-[340px] h-[350px] bg-[#010b139f] border border-[#ffffff25] md:shadow-custom-card'>
            <img src={gradient} alt="gradient" className={`absolute -top-28 w-72 opacity-75 ${className}`} />
            ...
            <div className='text-center mx-5 flex flex-col items-center'>
                <h2 className='text-2xl mb-4 font-semibold text-white'>{title}</h2>
